...
let activePlayer = "X";
//This array stores an array of moves. We use this to determine win condisitons.
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If activePlace is equal to 'X, the x.png is placed in HTML.
        ...
        if(activePlayer === 'O'){
            //This function diaables clicking for computer choice.
            disableClick();
    ...
    function computersTurn() {
        ...
        while(!success) {
            ...
            //If the random number evealuates returns true, the square hasn't been selected yet.
...
function checkWinConditions() {
    ...
    // O 6, 4, 2 condition.
    else if (arrayIncludes('6O','4O', '2O')) { drawWinLine(100, 50, 510, 90); }
    // O 0, 4, 8 condition.
    else if (arrayIncludes('0O','4O', '8O')) { drawWinLine(100, 100, 520, 520); }
    // This condition checks for tio. If none of the above conditions register
